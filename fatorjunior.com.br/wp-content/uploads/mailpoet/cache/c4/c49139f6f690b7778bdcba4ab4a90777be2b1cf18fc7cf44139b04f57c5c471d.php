...
/* settings/mta.html */
class __TwigTemplate_9bbc04e812d7fc0fd6ac0e0d16adc66177eb9ddd16e1184529c6f4830759b3fa extends Twig_Template
{
      ...
      <tr>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["interval"]) {
            ...
            echo "\"
                ";
            // line 296
            if (( !$this->getAttribute($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "mta", array()), "frequency", array()), "interval", array()) && (            // line 297
      ...
      <tr class=\"mailpoet_smtp_field\" data-field=\"authentication\"
        ...
        <td>
          <label>
            ...
            ";
        // line 585
        if (( !$this->getAttribute($this->getAttribute(($context["settings"] ?? null), "mta", array()), "authentication", array()) || ($this->getAttribute($this->getAttribute(        // line 586
...
";
    ...
    {
        return new Twig_Source("", "settings/mta.html", "/var/www/fatorjunior.com.br/wp-content/plugins/mailpoet/views/settings/mta.html");
    }
}
